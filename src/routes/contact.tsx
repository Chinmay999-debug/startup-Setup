        ...
        <section className="relative overflow-hidden bg-hero pb-16 pt-28 sm:pb-20 sm:pt-36 lg:pb-24 lg:pt-44 grain">
          ...
          <div className="relative mx-auto max-w-3xl px-5 text-center sm:px-6">
            ...
            <motion.h1
              ...
              className="mt-7 text-balance font-display text-[36px] leading-[1.05] tracking-[-0.025em] sm:text-6xl"
            >
              Let's design a workflow around your business.
            </motion.h1>
            <p className="mx-auto mt-6 max-w-xl text-pretty text-muted-foreground">
              Book a demo, send us your operational reality, or just chat on WhatsApp. We'll show
              you what your team's day looks like inside Startup Setup.
            </p>
          </div>
        </section>
