...
function IndustriesPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        {/* Hero */}
        <section className="relative overflow-hidden bg-hero pb-8 pt-28 sm:pt-36 lg:pb-10 lg:pt-44 grain">
          ...
          <div className="relative mx-auto max-w-5xl px-5 text-center sm:px-6">
            <span className="inline-flex items-center gap-2 rounded-full border hairline bg-card/80 px-3 py-1 text-xs text-muted-foreground shadow-soft backdrop-blur-sm">
              ...
              Industries we operate with
            </span>
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.1, duration: 0.9, ease: [0.22, 1, 0.36, 1] }}
              className="mt-7 text-balance font-display text-[36px] leading-[1.05] tracking-[-0.025em] sm:text-6xl lg:text-[64px]"
            >
              One software. Configured for the way your industry actually runs.
            </motion.h1>
            <p className="mx-auto mt-6 max-w-2xl text-pretty text-muted-foreground">
              Same operational engine, built around your stages, your team, and your channels. Not a
              generic CRM dressed for verticals.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-1.5">
              {verticalIndex.map((v) => (
                <a
                  key={v.key}
                  href={`#${v.key}`}
                  className="rounded-full border hairline bg-card/70 px-3 py-1.5 text-xs text-muted-foreground transition-colors hover:border-foreground/30 hover:text-foreground"
                >
                  {v.label}
                </a>
              ))}
            ...
            <motion.div
              ...
              className="relative mx-auto mt-9 max-w-4xl"
            >
              <div className="pointer-events-none absolute inset-x-10 top-1/2 h-16 -translate-y-1/2 rounded-full bg-accent/10 blur-3xl" />
              <div className="relative overflow-hidden rounded-2xl border hairline bg-card/70 text-left shadow-soft backdrop-blur-md">
            ...
            <Reveal>
              <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-end">
                <div className="lg:col-span-7">
                  ...
                  <h2 className="mt-3 font-display text-3xl tracking-tight md:text-[40px] md:leading-[1.08]">
          ...
          <div className="mx-auto max-w-6xl px-5 sm:px-6">
            <Reveal>
              <div className="mx-auto max-w-2xl text-center">
                <span className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">
                  Operational reality per vertical
                </span>
