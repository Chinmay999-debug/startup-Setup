...
function PrivacyPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar />
      <main>
        <section className="relative overflow-hidden bg-hero pb-16 pt-28 sm:pb-20 sm:pt-36 lg:pb-24 lg:pt-44 grain">
          ...
          <div className="relative mx-auto max-w-4xl px-5 sm:px-6">
            ...
            <Reveal delay={0.08}>
              <h1 className="mt-7 max-w-3xl text-balance font-display text-[36px] leading-[1.05] tracking-[-0.025em] sm:text-6xl">
                Privacy Policy
              </h1>
              <p className="mt-6 max-w-2xl text-pretty text-[16px] leading-[1.7] text-muted-foreground sm:text-[17px]">
                This policy explains how Startup Setup collects, uses, and protects information from
                website visitors, prospects, customers, and service users.
              </p>
            </Reveal>
          </div>
        </section>
