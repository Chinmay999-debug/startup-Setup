                  ...
                  {industry.sample.map((lead, index) => {
                    ...
                    return (
                      <motion.div
                        key={lead.name}
                        animate={{
                          backgroundColor: active ? "rgba(244, 177, 79, 0.10)" : "rgba(0,0,0,0)",
                        }}
        ...
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-3xl tracking-tight sm:text-4xl md:text-5xl">
              One system. Customized for your workflow.
            </h2>
            <p className="mt-4 text-pretty text-muted-foreground">
              Our lead management software adapts to the way different businesses operate. Same
              engine, your stages, your team, your communication.
            </p>
          </div>
        </Reveal>
